...
3. `READ gitnexus://repo/nv-sflow/process/{processName}` — trace the full execution flow step by step
...
| Resource | Use for |
|----------|---------|
| `gitnexus://repo/nv-sflow/context` | Codebase overview, check index freshness |
| `gitnexus://repo/nv-sflow/clusters` | All functional areas |
| `gitnexus://repo/nv-sflow/processes` | All execution flows |
| `gitnexus://repo/nv-sflow/process/{name}` | Step-by-step execution trace |
